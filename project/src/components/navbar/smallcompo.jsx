...
import {useNavigate} from 'react-router-dom'
  export default function Language() {
    ...
    return (
      <>
        <Button backgroundColor={'white'} _hover={"none"} onClick={onOpen}><span class="material-symbols-outlined">
language
</span>English</Button>
...
<option  value="">₹INR</option>
  ...
  export const SinginNav=()=> {
    ...
    return (
      <>
        <Button backgroundColor={'white'} _hover={"none"} onClick={onOpen}>Sing in</Button>
     ...
     <Button color={'#3662D8'}>Create a free account</Button>
